...
package mydemo.edu.com.myapplicationdemo.activity.alarm;
...
public class AlarmAlertActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new AlertDialog.Builder(AlarmAlertActivity.this).setIcon(R.drawable.icon_switch).setTitle(tile).setMessage(content).setCancelable(false).setPositiveButton("马上动身", new DialogInterface
				.OnClickListener() {
