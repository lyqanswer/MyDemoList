...
public class AddAndSubView extends LinearLayout {
    ...
    LinearLayout layoutFirst;   //view1
    LinearLayout layoutSecond;   //view2
    LinearLayout layoutThird;  //view3
    LinearLayout layoutFour;   //view4
    LinearLayout layoutFive;   //view5
    LinearLayout layoutSix;  //view6
    ...
    public AddAndSubView(Context context, int totalNum, String title) {
        super(context);
        num = 0;
        this.context = context;
    ...
    private void initialise() {
        ...
        layoutFirst = new LinearLayout(context);
        layoutSecond = new LinearLayout(context);
        layoutThird = new LinearLayout(context);
        layoutFour = new LinearLayout(context);
        layoutFive = new LinearLayout(context);
        layoutSix = new LinearLayout(context);
        ...
        textTotal.setText(String.valueOf(totalNum));
        textTotal.setTextSize(20);
        textTitle.setText(title);
        textTitle.setTextSize(20);
        textTitle.setSingleLine();
        textShow.setText("/");
        textShow.setTextSize(20);
    ...
    private void setViewsLayoutParm() {
        ...
        textTitle.setLayoutParams(viewLayoutParams);
        textShow.setLayoutParams(viewLayoutParams);
        textTotal.setLayoutParams(viewLayoutParams);
        setTextWidthHeight();

        viewLayoutParams.gravity = Gravity.CENTER;
        layoutThird.setLayoutParams(viewLayoutParams);
        //让editText不自动获得焦点
        layoutThird.setFocusable(true);
        layoutThird.setFocusableInTouchMode(true);

        viewLayoutParams.width = LayoutParams.WRAP_CONTENT;
        viewLayoutParams.weight = 1.0f;
        layoutFirst.setLayoutParams(viewLayoutParams);  //参数：宽、高、比重，比重为1.0
        layoutSecond.setLayoutParams(viewLayoutParams);  //参数：宽、高、比重，比重为1.0
        layoutFour.setLayoutParams(viewLayoutParams);
        layoutFive.setLayoutParams(viewLayoutParams);
        layoutSix.setLayoutParams(viewLayoutParams);
    ...
    private void insertView() {
        mainLinearLayout.addView(layoutFirst, 0);
        mainLinearLayout.addView(layoutSecond, 1);
        mainLinearLayout.addView(layoutThird, 2);
        mainLinearLayout.addView(layoutFour, 3);
        mainLinearLayout.addView(layoutFive, 4);
        mainLinearLayout.addView(layoutSix, 5);

        layoutFirst.addView(textTitle);
        layoutSecond.addView(subButton);
        layoutThird.addView(editText);
        layoutFour.addView(textShow);
        layoutFive.addView(textTotal);
        layoutSix.addView(addButton);
