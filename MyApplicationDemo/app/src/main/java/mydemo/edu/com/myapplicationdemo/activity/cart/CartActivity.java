package mydemo.edu.com.myapplicationdemo.activity.cart;
...
import mydemo.edu.com.myapplicationdemo.activity.cart.chatview.HorzinonlChartView;
import mydemo.edu.com.myapplicationdemo.activity.cart.chatview.MyChartView;
import mydemo.edu.com.myapplicationdemo.activity.cart.chatview.SingleView;
...
public class CartActivity extends AppCompatActivity {
    ...
    private void initChatView() {
        ...
        myChartView.setListener(new MyChartView.getNumberListener() {
            ...
            public void getNumber(int number, int x, int y) {
                relativeLayout.removeView(llChart);
                //反射加载点击柱状图弹出布局
                llChart = (LinearLayout) LayoutInflater.from(CartActivity.this).inflate(R.layout.layout_shouru_zhichu, null);
    ...
    private void initSingle() {
        ...
        mMySingleChartView.setListener(new SingleView.getNumberListener() {
            ...
            public void getNumber(int number, int x, int y) {
                rlSingle.removeView(llSingle);
                llSingle = (LinearLayout) LayoutInflater.from(CartActivity.this).inflate(R.layout.layout_pro_expense, null);
    ...
    private void initHorzion() {
        ...
        mAdapter = new ChartAdapter(CartActivity.this, horList);
