package mydemo.edu.com.myapplicationdemo.activity.recyclerView.decoration;
...
public class RecyclerViewItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public RecyclerViewItemDecoration(Context context, int orientation) {
        /*
         * 这个构造方法用于处理线性布局传入的情况，我们要对myDivider对象进行初始化 （绘制的颜色和宽度等等）
		 * R.drawable.my_list_divider 是我们自定义的一个drawable资源文件,我们通过 myContext来获取它
		 */
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (orientation == LINEAR_LAYOUT_ORIENTATION_HORIZONTAL || orientation == LINEAR_LAYOUT_ORIENTATION_VERTICAL) {
            linearLayoutDrawItemDecoration(c, parent);
        } else if (orientation == GRID_LAYOUT_ORIENTATION_HORIZONTAL || orientation == GRID_LAYOUT_ORIENTATION_VERTICAL) {
